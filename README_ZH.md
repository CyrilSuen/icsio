<p align="center">
  <img src="./public/icsio-logo.svg" width="112" height="112" alt="icsio 项目 Logo" />
</p>
...
<p align="center">
  ...
  <a href="https://icsio-demo.pages.dev/">在线体验</a>
</p>

## 项目简介

icsio 是运行在 Cloudflare Workers 上的浏览器笔记本。笔记始终是普通 Markdown 文本；在此基础上，应用提供专注写作、实时预览、关键词与可选语义搜索、双链导航、离线编辑、多设备同步、私有 AI 接入、公开分享和异地备份。
...
icsio 使用 [GNU Lesser General Public License v3.0 only](./LICENSE)，SPDX 标识为 `LGPL-3.0-only`。
