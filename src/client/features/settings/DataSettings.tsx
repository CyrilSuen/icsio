...
export function DataSettings() {
    ...
    const reportImport = async (result: Awaited<ReturnType<typeof api.transfer.import>>) => {
        ...
        if (result.warnings.length)
            console.warn(t("settings.icsio_import_reminder"), result.warnings);
    };
    useEffect(() => {
    ...
    return (<div className="space-y-6">
      ...
      <section>
        ...
        <SettingRow title={t("settings.import_file")} description={t("settings.supports_md_txt_zip_and_icsio_json_exports_for_matching_ids_the_newer")}>
