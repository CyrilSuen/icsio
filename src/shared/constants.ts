...
export const GITHUB_REPOSITORY_URL = 'https://github.com/shuaiplus/icsio'
export const GITHUB_PACKAGE_URL =
  'https://raw.githubusercontent.com/shuaiplus/icsio/refs/heads/main/package.json'
export const CLIENT_HEADER = 'X-icsio-Client'
export const SESSION_COOKIE = '__Host-icsio_session'
export const LEGACY_SESSION_COOKIE = 'icsio_session'
