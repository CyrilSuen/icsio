export const EN_US_MESSAGES = {
    ...
    "auth.between_the_paper_and_ink_the_pen_comes_to_life_an_icsio_is_used_to_p": "Between the paper and ink, the pen comes to life. icsio holds all your thoughts.",
    ...
    "markdown.info": "Info",
    "markdown.icsio_code_highlighting_failed_showing_plain_text": "[icsio] Code highlighting failed; showing plain text:",
    "markdown.icsio_diagram_rendering_failed_to_load": "[icsio] Diagram rendering failed to load:",
    "markdown.icsio_math_rendering_failed_to_load": "[icsio] Math rendering failed to load:",
    ...
    "pwa.install": "Install",
    "pwa.install_description": "Open icsio in its own window and keep the app shell available offline.",
    "pwa.install_icsio": "Install icsio",
    "pwa.installed": "Installed",
    "pwa.offline_ready": "All offline resources are ready",
    "pwa.offline_ready_description": "Every icsio feature can now open on this device without a network connection.",
    "pwa.complete_offline_access": "Complete offline access",
    "pwa.complete_offline_preparing_description": "icsio stays responsive while the remaining features download quietly in the background.",
    ...
    "pwa.complete_offline_retry_description": "Downloaded resources are kept. icsio will continue automatically when the connection returns.",
    ...
    "settings.update_dialog_description": "icsio {version} is available. Open the official repository and manually sync your Fork.",
    "settings.update_dialog_title": "A new version is available",
    "settings.update_manual_fork_hint": "icsio never changes or deploys your Fork automatically. Review the official repository, then sync it manually.",
    ...
    "settings.backup_manifest_not_found": "No icsio Markdown backup manifest was found. Select the complete extracted backup folder containing manifest.json, COMPLETE, and notes.",
    ...
    "settings.icsio_import_reminder": "[icsio] Import reminder:",
    ...
    "settings.mcp_demo_desc": "This page mirrors a configured icsio server so you can inspect every MCP option. The endpoint, credentials, clients, and index statistics are examples; all MCP actions are disabled in the demo.",
    ...
    "settings.restore_backup_folder": "Restore icsio backup folder",
    "settings.restore_backup_folder_description": "Select a folder extracted from the new ZIP, or a legacy backup root containing attachments and snapshots. icsio verifies COMPLETE and restores it in bounded batches.",
    ...
    "settings.supports_md_txt_zip_and_icsio_json_exports_for_matching_ids_the_newer": "Supports .md, .txt, .zip, and icsio .json exports. For matching IDs, the newer note wins.",
    "settings.sync": "Sync",
    ...
    "settings.totp_recovery_file_title": "icsio two-step verification recovery codes",
    ...
    "public.empty_filter": "No notes in this group yet",
    "public.back_home": "Back to home",
    "public.search_placeholder": "Search title, tags…",
    "public.hero_subtitle": "A self-hosted Markdown notebook for your notes.",
    "public.home": "Home",
    "share.listed_public": "List on public page",
    "share.listed_public_hint": "Anyone can find this note on the public homepage without signing in",
    ...
    "seed.welcome_note": `---
title: Welcome to icsio
tags: [getting-started, icsio]
aliases:
  - User guide
---
...
- [ ] Install icsio as an offline-capable PWA under **Settings → About**
...
- With Workers AI configured, icsio builds a per-account semantic index and combines semantic and keyword results. The index can be rebuilt or cleared, and content changes are indexed in the background.

> [!WARNING] Check an external AI client's privacy policy before connecting
> icsio isolates accounts and enforces permissions, but content an authorized client actually reads is then processed by that client.
...
![icsio project logo](/icsio-logo.svg "icsio project logo")
~~~~

~~~~md-example title="Wiki links"
[[My first note|Open or create a note]] · [[Welcome to icsio#Markdown quick reference|Jump to this section]]
~~~~
...
Press \`Ctrl + ,\` to change the interface language, theme, typography, editor, sync, or backup settings. You now know everything needed to use icsio. Keep this note as a reference or delete it and start writing. #getting-started
`,
} as const;
