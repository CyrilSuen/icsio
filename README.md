<p align="center">
  <img src="./public/icsio-logo.svg" width="112" height="112" alt="icsio project logo" />
</p>

<h1 align="center">icsio</h1>
...
1. Fork the icsio repository to your GitHub account.
...
Existing databases are upgraded automatically through versioned, idempotent migrations. Keep a current backup before updating any self-hosted deployment. When a newer stable icsio release is available, the owner receives a focused reminder without interrupting regular members.
...
icsio is distributed under the [GNU Lesser General Public License v3.0 only](./LICENSE), using the SPDX identifier `LGPL-3.0-only`.
